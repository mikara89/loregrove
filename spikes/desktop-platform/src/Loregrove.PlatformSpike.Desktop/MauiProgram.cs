...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddSingleton<IPlatformSpikeService, PlatformSpikeService>();
        builder.Services.AddSingleton<IDesktopPlatformService, MauiDesktopPlatformService>();
#if DEBUG
